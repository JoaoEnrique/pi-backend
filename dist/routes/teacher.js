...
router.get('/', (req, res) => {
    TeacherController_1.default.index(req, res);
});
router.post('/store', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield TeacherController_1.default.store(req, res);
}));
...
router.delete('/delete/:user_id', (req, res) => {
    TeacherController_1.default.delete(req, res);
});
router.put('/update/:user_id', (req, res, next) => {
    UserValidator_1.default.validate(req, res, next);
}, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    TeacherController_1.default.update(req, res);
}));
